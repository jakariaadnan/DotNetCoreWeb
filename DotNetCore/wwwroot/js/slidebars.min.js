...
$(document).ready(function() {
    ...
    $.slidebars = function(options) {
        ...
        windowWidth = $(window).width(), // Get width of window.
            $controls = $('.sb-toggle-left, .sb-toggle-right,.sb-custom-toggle-right, .sb-open-left, .sb-open-right, .sb-close'), // Cache the control classes.
        ...
        function open(side) {
            ...
            function proceed() {
                if (init && side === 'left' && $left) { // Slidebars is initiated, left is in use and called to open.
                    ...
                    //console.log($(this).find('.clsEmpId').val());
                }
            }
        }
        ...
        $('.sb-custom-toggle-right').on('touchend click', function (event) {
            eventHandler(event, $(this)); // Handle the event.
            let id = $(this).find('.clsEmpId').val();
            customToggle('right', id); // Toggle the right Slidbar.
